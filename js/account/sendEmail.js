...
$(document).ready(function(){
    ...
    $("#btn-send").click(function(){
        var registerMail = $.cookie("checkUserMail");
        callServieOther("sendActEmail",'/api/user/nologin/send-active-email',{
            "username":registerMail,
            "toUser":registerMail
        });
        time(document.getElementById("btn-send"));        
    });
    $("body").on("click",".icon-checkbox-unchecked",function () {
        $(this).removeClass("icon-checkbox-unchecked");
        $(this).addClass("icon-checkbox-checked");
    })
    $("body").on("click",".icon-checkbox-checked",function () {
